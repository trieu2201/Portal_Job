...
VALUES (
  ...
  (
    ...
    2,
    'Call Latter Send',
    'You are Invited For Interview on 10-MAR-2020.'
  ),
  (
    3,
    3,
...
VALUES (3, 3, 'B.C.A', 'Ganpat Universiy', 2011, 68.89),
...
VALUES (
    1,
    'Wipro Infotech',
    'Software Professional Required',
    2,
    'M.C.A',
    'ASP.NET'
  ),
  (
    ...
    5,
    'M.B.A',
    'Freshers Are Invited'
  ),
  (
    3,
    'TCS Private Limited',
    'Software Trainee Required',
    1,
    'B.Sc.I.T',
...
--
INSERT INTO `news_master` (`NewsId`, `News`, `NewsDate`)
VALUES (1, 'Register and Get JOB', '2020-09-24'),
  (
    2,
    'New Vacancies will be updated after diwali',
    '2020-10-31'
  );
-- --------------------------------------------------------
--
...
--
INSERT INTO `user_master` (`UserId`, `UserName`, `Password`)
VALUES (6, 'admin', 'admin'),
  (10, 'xyz', 'xyz');
-- --------------------------------------------------------
--
...
VALUES (
    ...
    5,
    'B.C.A',
    'Hardworking Person are Required.',
    '2020-09-25',
    '09:00:00'
  ),
  (
    2,
    'TCS Private Limited',
    'Marketive Representative Invited',
    2,
    'Pharmacist',
    'Ready TO work in North Gujarat',
    '2020-10-07',
    '09:00:00'
  );